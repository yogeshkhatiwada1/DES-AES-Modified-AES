...
public class AES {
    ...
    public static class AesResults {
        public String encryptedTextAes;
        public String DNAEncryptedTextAes;
        public String DNADecryptedTextAes;
        public String decryptedTextAes;
        public long encryptionTime;
        public long decryptionTime;
    }

    public static AesResults main(String[] args) {
        AesResults results = new AesResults();
        if (args.length > 0) {
            String filePath = args[0];
            String data = readFileToString(filePath);
            AES aes = new AES();
            String key = Home.aesKey;
            ...
            results.encryptedTextAes = encryptedText;
            results.DNAEncryptedTextAes = DNAcode;
            results.DNADecryptedTextAes = decodedmessage;
            results.decryptedTextAes = unencryptedText;
            results.encryptionTime = encryptionTime;
            results.decryptionTime = decryptionTime;
            Home.AESMethod(results);
            return results;
        } else {
            System.exit(1);
        }
